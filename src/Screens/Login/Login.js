...
const LoginPage = ({navigation}) => {
  ...
  const goToScreenProfile = (username,ap,am,id_User,flagregistro) => {
    navigation.navigate(navigationStrings.PROFILE, {username:username,ap:ap,am:am,id_User:id_User,flagregistro:flagregistro});
  };
  const ToastShow = () => {
        ...
        .then(response => {
          ...
          if (response.data.length == 0) {
            ...
            response.data.map(item=>{
              ...
              goToScreenProfile(username,ap,am,id_User,flagregistro);
            })
